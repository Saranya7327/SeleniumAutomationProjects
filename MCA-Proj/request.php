           ...
           <div class="panel panel-info">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="map" required />
                    <!-- <p class="help-block">Help text here.</p> -->
                </div>


                <div class="form-group">
                    <label>Complaint Site Image1 </label>
                    <input name="Image1" id="image" accept="image/JPEG" type="file" required>
                </div>


               <!-- <div class="form-group">
                    <label>Complaint Site Image2 </label>
                    <input name="Image2" id="image" accept="image/JPEG" type="file" required>
                </div>-->
